...
class TripController extends Controller {
    ...
    public function index(Request $request){
        ...
        elseif($request->input('page_name') == 'create'){

            if(!$request->input('type')){
                Toastr::error('আগে গাড়ী ভাড়ার মাধ্যম নির্বাচন করুন');
                return redirect()->back();
            }
            ...
            if($request->input('type') == 'out_from_market' || $request->input('type') == 'out_nagad_commission'){
                $data['unique_vehicle_numbers'] = TripProvider::latest()->get(['vehicle_number'])->unique('vehicle_number');
            ...
            if($request->input('type') == 'out_from_market'){
                $data['action_url'] = 'out-from-market';
            } elseif($request->input('type') == 'out_nagad_commission') {
                $data['action_url'] = 'out-nagad-commission';
            } elseif($request->input('type') == 'own_vehicle') {
                $data['action_url'] = 'own-vehicle';
            }
        ...
        // will remove this
        // elseif($request->input('page_name') == 'demarage_create'){
        //     $data['top_title'] = __('cmn.now_you_are_on_the') .' '.__('cmn.demarage_entry').' '.__('cmn.page');
        //     $data['title'] =  __('cmn.now_you_are_on_the') .' '.__('cmn.demarage_entry').' '.__('cmn.page');
        //     $data['menu'] = 'trip_demarage';
        //     $data['sub_menu'] = 'trip_demarage_create';
