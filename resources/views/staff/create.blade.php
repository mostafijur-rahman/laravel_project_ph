                    ...
                    <form action="{{ url('/staffs') }}"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" required>
                                                <option value="male" {{ old('gender')=='male' ? 'selected':'' }}>@lang('cmn.male')</option>
                                                <option value="female" {{ old('gender')=='female' ? 'selected':'' }}>@lang('cmn.female')</option>
                                                <option value="third_gender" {{ old('gender')=='third_gender' ? 'selected':'' }}>@lang('cmn.third_gender')</option>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="name" name="name" value="{{ old('name') }}" placeholder="@lang('cmn.name')" required>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" id="phone" name="phone" value="{{ old('phone') }}" placeholder="0171 xxx xxx" required>
                                            @if ($errors->has('phone'))
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="email" name="email" value="{{ old('email') }}" placeholder="examaple@gmail.com">
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" id="father_name" name="father_name" value="{{ old('father_name') }}" placeholder="@lang('cmn.father_name')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('mother_name') ? 'is-invalid' : '' }}" id="mother_name" name="mother_name" value="{{ old('mother_name') }}" placeholder="@lang('cmn.mother_name')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('spouse_name') ? 'is-invalid' : '' }}" id="spouse_name" name="spouse_name" value="{{ old('spouse_name') }}" placeholder="@lang('cmn.spouse_name')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control {{ $errors->has('present_address') ? 'is-invalid' : '' }}" id="present_address" name="present_address" rows="1" placeholder="@lang('cmn.present_address')">{{ old('present_address') }}</textarea>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control {{ $errors->has('permanent_address') ? 'is-invalid' : '' }}" id="permanent_address" name="permanent_address" rows="1" placeholder="@lang('cmn.permanent_address')">{{ old('permanent_address') }}</textarea>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="dob" data-target-input="nearest">
                                                <input type="text" name="dob" value="{{ date('d/m/Y') }}" class="form-control datetimepicker-input {{ $errors->has('dob') ? 'is-invalid' : '' }}" data-target="#reservationdate" required>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('company_id') ? 'is-invalid' : '' }}" id="company_id" name="company_id" value="{{ old('company_id') }}" placeholder="@lang('cmn.company_id')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="joining_date" data-target-input="nearest">
                                                <input type="text" name="joining_date" value="{{ date('d/m/Y') }}" class="form-control datetimepicker-input {{ $errors->has('joining_date') ? 'is-invalid' : '' }}" data-target="#reservationdate" required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('nid_number') ? 'is-invalid' : '' }}" id="nid_number" name="nid_number" value="{{ old('nid_number') }}" placeholder="@lang('cmn.nid_number')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('driving_license_number') ? 'is-invalid' : '' }}" id="driving_license_number" name="driving_license_number" value="{{ old('driving_license_number') }}" placeholder="@lang('cmn.driving_license_number')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" {{ $errors->has('passport_number') ? 'is-invalid' : '' }} id="passport_number" name="passport_number" value="{{ old('passport_number') }}" placeholder="@lang('cmn.passport_number')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('birth_certificate_number') ? 'is-invalid' : '' }}" id="birth_certificate_number" name="birth_certificate_number" value="{{ old('birth_certificate_number') }}" placeholder="@lang('cmn.birth_certificate_number')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('port_id') ? 'is-invalid' : '' }}" id="port_id" name="port_id" value="{{ old('port_id') }}" placeholder="@lang('cmn.port_id')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('bank_account_number') ? 'is-invalid' : '' }}" id="bank_account_number" name="bank_account_number" value="{{ old('bank_account_number') }}" placeholder="@lang('cmn.bank_account_number')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control {{ $errors->has('salary_amount') ? 'is-invalid' : '' }}" id="salary_amount" name="salary_amount" value="{{ old('salary_amount') }}" placeholder="@lang('cmn.salary_amount')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control {{ $errors->has('termination_date') ? 'is-invalid' : '' }}" id="termination_date" name="termination_date" value="{{ old('termination_date') }}">
                        ...
                        <div class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('reference_name') ? 'is-invalid' : '' }}" id="reference_name" name="reference_name" value="{{ old('reference_name') }}" placeholder="@lang('cmn.name')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('reference_phone') ? 'is-invalid' : '' }}" id="reference_phone" name="reference_phone" value="{{ old('reference_phone') }}" placeholder="0171 xxx xxx">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">@lang('cmn.nid_number')</label>
                                            <input type="text" class="form-control {{ $errors->has('reference_nid_number') ? 'is-invalid' : '' }}" id="reference_nid_number" name="reference_nid_number" value="{{ old('reference_nid_number') }}" placeholder="@lang('cmn.nid_number')">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="">@lang('cmn.present_address')</label>
                                            <textarea  class="form-control {{ $errors->has('reference_present_address') ? 'is-invalid' : '' }}" id="reference_present_address" name="reference_present_address" rows="1" placeholder="@lang('cmn.present_address')">{{ old('reference_present_address') }}</textarea>
                                ...
                                <div id="labelFields" class="labelFields">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="label" placeholder="@lang('cmn.label_name_here')" name="labels[]" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <button type="button" class="form-control btn btn-md btn-success" onclick="add()"><i class='fas fa-plus'></i></button>
                                        </div>
                                    </div>
                                </div>
