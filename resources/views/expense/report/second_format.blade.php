	...
	<body>
		...
		<main>
            ...
            <div class="invoice-box">
				<table class="table-design" cellpadding="0" cellspacing="0" style="table-layout: fixed">
					...
					<tr>
						...
						@if(count($setting_vehicles) > 0)
							<td class="center" width="2%">@lang('cmn.sl')</td>
							<td class="center" width="5%">@lang('cmn.vehicle')</td>
						@endif
						...
						@if(count($setting_expenses) > 0)
							...
							@endforeach
						@endif
						<td class="center" width="8%">@lang('cmn.total')</td>
					</tr>
					...
					<tr>
						...
						@if(count($setting_vehicles) > 0)
							...
							<td class="center" colspan="2">@lang('cmn.total') =</td>
