            ...
            <div class="card-header">
                <form method="GET" name="form">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="voucher_id" value="{{ old('voucher_id', $request->voucher_id) }}" placeholder="@lang('cmn.voucher_id')">
                            </div>
                        </div>
                        {{-- <div class="col-md-3">
                            <div class="form-group">
