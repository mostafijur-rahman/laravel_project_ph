...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">@lang('cmn.company_billing_report')</h3>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ url('company-report') }}" target="_blank" id="company_billing_form">
                    <div class="row">
                        <input type="hidden" name="report_name" value="company_billing">
                        <div class="col-md-3">
    ...
    {{-- <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ url('company-report') }}" target="_blank">
                    <div class="row">
                        <input type="hidden" name="type" value="chalan_paid">
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="trip_number" value="{{ old('trip_number', $request->trip_number) }}" placeholder="@lang('cmn.write_trip_number_here')">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
            ...
            <div class="card-body">
                <form method="GET" action="{{ url('company-report') }}" target="_blank">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="hidden" name="type" value="demarage_paid">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" class="form-control" list="challan_number_else" name="trip_number" value="{{ old('trip_number', $request->trip_number) }}" placeholder="@lang('cmn.write_trip_number_here')">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
