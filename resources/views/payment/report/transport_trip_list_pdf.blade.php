				...
				<div class="row mb-3">
					...
					<div class="top-bar-info text-center">
                        ...
                        <div style="font-size: 16px">
							{{ $title ?? '' }} রিদিশা ফুড (1-15,Nov,2021)
						</div>
					</div>
			...
			<div class="invoice-box">
				<table class="table-design" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="center" width="10%">অগ্রীম</td>
                        <td class="center" width="10%">চালান বাকী</td>
                        <td class="center" width="10%">পয়েন্ট</td>
                        <td class="center" width="10%">কাটুন</td>
