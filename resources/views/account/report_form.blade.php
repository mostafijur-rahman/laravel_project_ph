...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="GET" action="{{ url('account-report') }}" target="_blank">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="account_id" class="form-control">
                                    <option value="">@lang('cmn.all_accounts')</option>
                                    @foreach($accounts as $account)
                                    <option value="{{ $account->id }}">{{$account->user_name }} ({{ $account->account_number??__('cmn.cash') }} )</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
