...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#brand_add" title="Add"><i class="fa fa-plus"></i> @lang('cmn.add')</button>
                                    @endif
                                </div>
                            </div>
                        </div>
            ...
            {{-- bank add --}}
            <div class="modal fade" id="brand_add">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form action="{{ url('settings/brands') }}"  method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                                <h4 class="modal-title">@lang('cmn.brand') @lang('cmn.form')</h4>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="">@lang('cmn.brand') <small class="text-danger">(@lang('cmn.required'))</small></label>
                                    <input type="text" class="form-control" name="name" id="name" value="{{ old('invesor_name')}}" placeholder="@lang('cmn.brand')" required>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        <form action=""  method="post" id="action_edit">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <label for="">@lang('cmn.brand') <small class="text-danger">(@lang('cmn.required'))</small></label>
                                    <input type="text" class="form-control" name="name" id="name_edit" value="{{ old('brand_name')}}" placeholder="@lang('cmn.brand')" required>
                                </div>
                            </div>
                            <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-times"></i> @lang('cmn.close')</button>
                    ...
                    <table class="table table-striped text-center table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>
                                    <form action="{{ url('settings/brand-sort') }}" method="POST">
                                        @csrf
                                ...
                                <td>
                                    ...
                                    <form id="{{$list->id}}" action="{{ url('settings/brands',$list->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    @endif
...
<script type="text/javascript">
    ...
    function editData(value){
        ...
        $('#action_edit').attr('action', '/settings/brands/' + value.id);
