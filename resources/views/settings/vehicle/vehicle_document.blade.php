                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            ...
                            <a href="{{ url('vehicle') }}" class="btn btn-sm btn-primary float-right"><i class="fa fa-arrow-left"></i> Vehicle List</a>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ url('vehicle-document-update', $list->car_encrypt) }}"  method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="">Reg. Reminder Date</label>
                                    <input type="date" class="form-control" name="car_reg_reminder_date" value="{{ old('car_reg_reminder_date', $list->car_reg_reminder_date)}}" placeholder="reg. reminder date">
                                </div>
                                <div class="form-group">
