                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-default">
                        <div class="card-header">
                            <h3 class="card-title">@lang('cmn.pump') @lang('cmn.add') @lang('cmn.form')</h3>
                        ...
                        <form action="{{ url('/pump') }}"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ old('name')}}" placeholder="@lang('cmn.pump_name')" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
