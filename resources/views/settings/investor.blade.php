    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card"> 
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="head" value="{{ old('head',$request->head) }}" placeholder="@lang('cmn.investor')">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-md btn-success" data-toggle="modal" data-target="#investor_add" title="Add"><i class="fa fa-plus"></i> @lang('cmn.add')</button>
                                    @endif
                                </div>
                            </div>
                        </div>
               ...
               <!-- investor add -->
                <div class="modal fade" id="investor_add">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form action="{{ url('settings/investors') }}"  method="post">
                                @csrf
                                <div class="modal-header">
                                    <h4 class="modal-title">@lang('cmn.investor') @lang('cmn.form')</h4>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="">@lang('cmn.investor') <small class="text-danger">(@lang('cmn.required'))</small></label>
                                        <input type="text" class="form-control" name="name" value="{{ old('invesor_name')}}" placeholder="@lang('cmn.investor')" required>
                                    </div>
                                </div>
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-times"></i> @lang('cmn.close')</button>
                                    <button type="submit" class="btn btn-success"><i class="fas fa-upload"></i> @lang('cmn.do_posting')</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <!-- investor edit -->
                <div class="modal fade" id="investor_edit">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form action="" id="action_edit"  method="post">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="">@lang('cmn.investor') <small class="text-danger">(@lang('cmn.required'))</small></label>
                                        <input type="text" class="form-control" name="name" id="name_edit" value="{{ old('invesor_name')}}" placeholder="@lang('cmn.investor')" required>
                                    </div>
                                </div>
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-times"></i> @lang('cmn.close')</button>
                    ...
                    <table class="table table-striped text-center table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>
                                    <form action="{{ url('settings/investor-sort') }}" method="POST">
                                        @csrf
                                ...
                                <td>
                                    ...
                                    <form id="{{$list->id}}" action="{{ url('settings/investors',$list->id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    @endif
...
<script type="text/javascript">
    ...
    function editData(value){
        ...
        $("#investor_edit").modal("show");

        $("#name_edit").val(value.name);
 
        $('#action_edit').attr('action', '');
        
        $('#action_edit').attr('action', '/settings/investors/' + value.id);
    }
    function submitForm(){
