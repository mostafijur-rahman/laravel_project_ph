...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="GET" action="{{ url('daily-accounts-report-first-format') }}" target="_blank">
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <button type="submit" class="btn btn-md btn-primary" onclick="downloadPdf('all','false')"><i class="fa fa-file-alt"></i> @lang('cmn.show_report')</button>
                                <button type="submit" class="btn btn-md btn-primary" onclick="downloadPdf('all','true')"><i class="fa fa-cloud-download-alt"></i> @lang('cmn.download')</button>
                                <input type="hidden" name="download_pdf" id="download_pdf_all" value="false">
                            </div>
                        </div>
                    </div>
                </form>
        ...
        {{-- <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="GET" action="{{ url('daily-accounts-report') }}" target="_blank">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <select name="date_range_status" id="range_status_all" onchange="dateRangeVisibility('all')" class="form-control">
