                    ...
                    <tr class="text-center">
                        <td class="text-left">
                            <small>
                                ...
                                @lang('cmn.vehicle'): <b>{{ $trip->provider->vehicle_number }}</b> <span class="btn btn-xs" style="color: #1f2d3d; background-color: #4dff4d; border-color: #4dff4d; box-shadow: none;">@lang('cmn.cash_commission')</span><br>
                                ...
                                <div class="row mt-2">
                                    <div class="btn-group">
                                        ...
                                        <a href="{{ url('trips?page_name=edit&type=out_nagad_commission&trip_id='. $trip->id) }}" class="btn btn-default btn-xs mr-1" aria-label="@lang('cmn.edit')">@lang('cmn.edit')</a>
                                        <a href="{{ url('trips?page_name=copy&type=out_nagad_commission&trip_id='. $trip->id) }}" class="btn btn-default btn-xs mr-1" aria-label="@lang('cmn.copy')">@lang('cmn.copy')</a>
                                        <a href="{{ url('trips?page_name=details&type=out_nagad_commission&trip_id='. $trip->id) }}" class="btn btn-xs {{ ($request['page_name'] == 'details')?'btn-primary':'btn-default' }}" aria-label="@lang('cmn.details')">@lang('cmn.details')</a>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="btn-group">
                                        <a href="{{ url('trips?page_name=general_expense&type=out_nagad_commission&trip_id='. $trip->id) }}" class="btn btn-xs mr-1 {{ ($request['page_name'] == 'general_expense')?'btn-primary':'btn-default' }}" aria-label="@lang('cmn.general_expense')">@lang('cmn.general_expense')</a>
                                        @if(!$trip->challanHistoryReceived)
