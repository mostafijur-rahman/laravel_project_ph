        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <a href="{{ url('trips?page_name=list&&per_page=50&order_by=desc') }}" class="btn btn-sm btn-info"><i class="fa fa-times"></i> @lang('cmn.clear')</a>
                    <a href="{{ url('trips?page_name=create&type=out') }}" class="btn btn-sm btn-success">@lang('cmn.challan_create')</a>
                </div>
            </div>
        </div>
    </form>
