<tr>
    <td class="text-left">
        <small>
            ...
            @lang('cmn.vehicle'): <b>{{ $trip->provider->vehicle_number }}</b> <span class="btn btn-xs btn-warning">@lang('cmn.cash_commission')</span><br>
            ...
            <div class="row mt-2">
                <div class="btn-group">
                    ...
                    <button class="btn btn-secondary btn-xs" onclick="challanReceived({{ json_encode($trip) }})" title="@lang('cmn.challan_received')">@lang('cmn.challan_received')</button>
                </div>
            </div>
            @if($trip->note)
            <div class="row mt-2">
