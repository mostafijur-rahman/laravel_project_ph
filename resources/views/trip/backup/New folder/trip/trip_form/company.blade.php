        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control {{ $errors->has('com_contract_fair') ? 'is-invalid' : '' }}" name="com_contract_fair" value="{{ old('com_contract_fair', (($trip && $trip->company->contract_fair) ? (float) $trip->company->contract_fair:0)) }}" placeholder="@lang('cmn.amount_here')" {{ ($request->page_name =='edit')?'disabled':''}}>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control {{ $errors->has('com_advance_fair') ? 'is-invalid' : '' }}" name="com_advance_fair" value="{{ old('com_advance_fair', (($trip && $trip->company->advance_fair) ? (float) $trip->company->advance_fair:0)) }}" placeholder="@lang('cmn.amount_here')" {{ ($request->page_name =='edit')?'disabled':''}}>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('com_account_id') ? 'is-invalid' : '' }}" style="width: 100%;" name="com_account_id" {{ ($request->page_name =='edit')?'disabled':''}}>
                        @if(isset($accounts))
