                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-left">
                                        <small>
                                            ...
                                            @lang('cmn.demarage_fixed'): <b>---</b><br>
                                            @lang('cmn.demarage_paid'): <b>---</b><br>
                                            @lang('cmn.demarage_due'): <b>---</b><br>
                                    ...
                                    <td class="text-left">
                                        <small>
                                            ...
                                            @lang('cmn.challan_due'): <b>---</b><br>
                                            @lang('cmn.demarage_charge'): <b>---</b><br>
                                            @lang('cmn.demarage_received'): <b>---</b><br>
                                            @lang('cmn.demarage_due'): <b>---</b><br>
                                            @lang('cmn.discount'): <b>---</b><br>
                                            কার্টুন সংখ্যা: <b>---</b><br>
                                            ওজন: <b>---</b><br>
                                        </small>
                                    </td>
                                    <td class="text-right">
                                        <small>
                                            @lang('cmn.contract_commission') = <b>---</b><br>
                                            <div style="border-bottom: 2px dashed grey; margin-left: 16px;">
                                                কোম্পানী থেকে গ্রহণ = <b>---</b><br>
                                                ভাড়া বাবদ প্রদান = <b>---</b><br>
                                            </div>
                                            <div style="border-bottom: 2px dashed grey; margin-left: 16px;">
                                                @lang('cmn.commission_received') = <b>---</b><br>
                                                @lang('cmn.demarage_commission') = <b>---</b><br>
                                            </div>
                                            @lang('cmn.total_commission') = <b>---</b><br>
                                            {{-- (@lang('cmn.challan_due') = <b>---</b>, @lang('cmn.discount') = <b>---</b>) --}}
                                        </small>
                                    </td>
                                </tr>
