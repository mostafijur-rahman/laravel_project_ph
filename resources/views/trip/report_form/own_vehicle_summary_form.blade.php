<section class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">@lang('cmn.own_vehicle_summary_report')</h3>
        </div>
        <div class="card-body">
            <form method="GET" action="{{ url('own-vehicle-summary-report') }}" target="_blank">
                <div class="row">
                    <input type="hidden" name="report_name" value="own_vehicle_summary">
                    <div class="col-md-3">
