...
@if($trip)
    ...
    @php  
        if($trip->group_id){
            ...
            $tripGeneralExpenseLists = tripExpenseListsByTripId($trip->id);
        }
    @endphp
                    ...
                    <table class="table table-bordered table-striped text-center table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">@lang('cmn.voucher_id')</th>
                        ...
                        <tbody id="expense_tbody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <small>{{ date('d M, Y', strtotime($expense->date)) }}</small>
                                </td>
                                <td>
                                    <small>
                                        {{ $expense->head }}
                                ...
                                <td>
                                    <button type="button" class="btn btn-xs bg-gradient-danger" onclick="return deleteCertification({{ $expense->id  }}, 'expense')" title="@lang('cmn.delete')">@lang('cmn.delete')</button>
                            ...
                            <tr style="font-weight: bold;">
                                <td colspan="4" class="text-right"><small><b>@lang('cmn.total') =</small></b></td>
