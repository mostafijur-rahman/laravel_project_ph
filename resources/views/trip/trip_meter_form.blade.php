            ...
            <table class="table table-bordered text-center text-nowrap">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-xs bg-gradient-danger" onclick="return deleteCertification({{ $trip->meter->id }}, 'meter')" title="@lang('cmn.delete')">@lang('cmn.delete')</button>
