...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">@lang('cmn.provider_billing_report')</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form method="GET" action="{{ url('provider-report') }}" id="form" target="_blank">
                    <input type="hidden" name="report_name" value="provider_billing">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="form-control" name="paid_status">
                                    ...
                                    <option value="due_challan">@lang('cmn.due_challan')</option>
                                    <option value="paid_challan">@lang('cmn.paid_challan')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3" id="month_field_1" style="display: none;">
                            <div class="form-group">
                        ...
                        <div class="col-md-3" id="year_field_1" style="display: none;">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" class="form-control" list="provider_owner_name_else" name="provider_owner_name" value="{{ old('provider_owner_name', $request->provider_owner_name) }}" placeholder="@lang('cmn.write_provider_owner_name_here')">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <button type="submit" class="btn btn-sm btn-primary" onclick="downloadPdf('false')">
                                    <i class="fa fa-file-alt"></i> @lang('cmn.show_report')
                                </button>
                                <button type="submit" class="btn btn-sm btn-primary" onclick="downloadPdf('true')">
    ...
    {{-- <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">@lang('cmn.challan_paid') @lang('cmn.report_form')</h3>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ url('provider-report') }}" id="form" target="_blank">
                    <div class="row">
                    <input type="hidden" name="report_type" value="challan_paid">
                        <div class="col-md-3">
                            <div class="form-group">
    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">@lang('cmn.demarage') @lang('cmn.report_form')</h3>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ url('provider-report') }}" id="form" target="_blank">
                    <input type="hidden" name="report_name" value="demarage">
                    <div class="row">
                        <input type="hidden" name="report_type" value="demarage_paid">
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="order_by" class="form-control">
                                    <option value="asc" {{ old('from_start',$request->order_by)=='asc' ? 'selected':'' }}>@lang('cmn.from_start')</option>
                                    <option value="desc" {{ old('from_end',$request->order_by)=='desc' ? 'selected':'' }}>@lang('cmn.from_end')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="form-control" name="demarage_status">
                                    <option value="all_demarage">@lang('cmn.all_challan')</option>
                                    <option value="due_demarage">@lang('cmn.due')</option>
                                    <option value="paid_demarage">@lang('cmn.paid')</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-2" id="month_field_4" style="display: none;">
                            <div class="form-group">
                                <select name="month" class="form-control">
                                    <option value="">@lang('cmn.select_month')</option>
                                    <option value="1" {{ old('month',$request->month)==1 ? 'selected':'' }}>@lang('cmn.january')</option>
                        ...
                        <div class="col-md-2" id="year_field_4" style="display: none;">
                            <div class="form-group">
                                <select name="year" class="form-control">
                                    <option value="">@lang('cmn.select_year')</option>
                                    @foreach(range(date('Y'), 2010) as $year)
